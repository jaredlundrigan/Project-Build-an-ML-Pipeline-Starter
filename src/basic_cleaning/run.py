...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "Name of the raw data artifact to pull from W&B",
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "Name to give the cleaned data artifact",
        required = True
    )
    ...
    parser.add_argument(
        "--output_type", 
        type = str,
        help = "Type label for the output artifact",
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = "A short sentence saying what the output artifact is",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "Lowest price to keep, rows under this get dropped",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "Highest price to keep, rows over this get dropped",
        required = True
    )
